...
import static com.aneesh.problemSolvingAndAlgorithms.QueensAttackII.findMaxMoves;

public class QueensAttackIIv4 {
        ...
        static int queensAttack(int boardSize, int numberOfObstacles, int queen_y, int queen_x, int[][] obstacles) {
            ...
            //calculate distance of them from queen

            for (int[] i : obstacles) {

                int differenceIn_Y = i[0] - queen_y;
                int differenceIn_X = i[1] - queen_x;

                //int directionOfObstacle = findDirection(differenceIn_Y, differenceIn_X);
                if(differenceIn_Y == 0 || differenceIn_X == 0 ||Math.abs(differenceIn_Y) - Math.abs(differenceIn_X) == 0 ){

                    //if the correct direction difference is less than current value, then adjust the value;
                    int distanceToQueen = Math.max(Math.abs(differenceIn_Y), Math.abs(differenceIn_X)) -1;

                    //work out direction
                    if(differenceIn_X == 0 && differenceIn_Y > 0){
                        //north
                        north = distanceToQueen  < north ? distanceToQueen  : north;
                    }
                    else if(differenceIn_X == 0 && differenceIn_Y < 0){
                        //south
                        south = distanceToQueen  < south ? distanceToQueen  : south;

                    }
                    else if(differenceIn_X > 0 && differenceIn_Y == 0){
                        //east
                        east = distanceToQueen < east ? distanceToQueen : east;
                    }
                    else if(differenceIn_X < 0 && differenceIn_Y == 0){
                        //west
                        west = distanceToQueen < west ? distanceToQueen  : west;
                    }
                    else if(differenceIn_X > 0 && differenceIn_Y > 0){
                        //northEast
                        northEast = distanceToQueen < northEast ? distanceToQueen : northEast;
                    }
                    else if(differenceIn_X > 0 && differenceIn_Y < 0){
                        //southEast
                        southEast = distanceToQueen < southEast ? distanceToQueen  : southEast;
                    }
                    else if(differenceIn_X < 0 && differenceIn_Y > 0){
                        //northWest
                        northWest = distanceToQueen < northWest ? distanceToQueen  : northWest;
                    }
                    else if(differenceIn_X < 0 && differenceIn_Y < 0){
                        //southWest
                        southWest = distanceToQueen < southWest ? distanceToQueen  : southWest;
            ...
            directions = Arrays.asList(north, south, east, west, northEast, northWest, southEast, southWest);
            ...
            //less distance from queen from the max moves
            return sum;
        }
